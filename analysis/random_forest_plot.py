...
tree.export_graphviz(clf.estimators_[10], out_file=dot_data)
graph = pydot.graph_from_dot_data(dot_data.getvalue())
graph.write_png("/Users/jeremy/GoogleDrive/PSU/thesis/itunes_data/itunes_us_data/randomForest.png")
