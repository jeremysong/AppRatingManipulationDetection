...
abusedAppFile = open("/Users/jeremy/GoogleDrive/PSU/thesis/itunes_data/itunes_cn_data/classification_abused_app.txt", 'r')
...
for abused_app_id in abused_app_list:
    ...
    print("App id: {0}, app name: {1}, developer name: {2}.".format(abused_app_id, app_name, developer_name))